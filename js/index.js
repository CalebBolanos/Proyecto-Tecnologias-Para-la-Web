...
const validarFormulario = (e)=>{
    ...
    if(document.querySelector('#chkYes')) {
        campos.otro = true;
    }
    if(campos.otro){
        switch(e.target.id){
...
if(campos.boleta && campos.nombre && campos.apellidop && campos.apellidom && campos.curp && campos.calleNumero && campos.colonia && campos.cp && campos.telefono && campos.mail && campos.promedio){
    if(campos.fecha){
        if(campos.otro){
            if(campos.campootro){
