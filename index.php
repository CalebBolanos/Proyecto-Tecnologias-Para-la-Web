    ...
    <div class="container py-3">
        <header>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-6 fw-normal">Registro de datos generales para alumnos de nuevo ingreso (enero 2021)</h1>
                <p class="fs-5 text-muted">Llena el siguiente formulario, en el cual se te pedira información acerca de tu identidad, contacto y procedencia.</p>
            </div>
        </header>
        <main>
            <div class="row">
            <div class="col-12 bg-white tarjeta">
                    <form class="needs-validation"  method="POST" action="verificarDatos.php" id="formulario" novalidate>
                        <div class="row g-3 ">
                            <div class="col-md-12 ">
                                <h3>Identidad</h3>
                            </div>
                        ...
                        <div class="row g-3 ">
                            ...
                            <div class="col-md-8">
                                ...
                                <select class="form-select" aria-label="Default select example" name="alcaldia" id="alcaldia" required>
                                        <option value="" selected disable hidden >Selecciona una alcaldía</option>
                        ...
                        <div class="row g-3 ">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="escuelaP" id="chkYes" <?php echo ($escuelaP == 'on') ? 'checked' : ''; ?> required>
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select" aria-label="Default select example" name="estado" id="estado" required>
                                        <option value="" selected disable hidden >Selecciona una entidad federativa</option>
                            ...
                            <div class="col-md-4 d-md-flex justify-content-md-end">
                                <input type="reset" class="btn btn btn-outline-secondary" value="Limpiar formulario"></button>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md">
                    ...
                    <ul class="list-unstyled text-small">
                        <li class="mb-1"><a class="link-secondary text-decoration-none" href="administrador/iniciarSesion.php">Iniciar Sesión</a></li>
                    </ul>
                </div>
                <div class="col-6 col-md">
